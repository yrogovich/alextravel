...
<div class="tour-page">
    ...
    <header class="tour-name iceland">
        ...
        <div class="container">
            <div class="relative">
                <div data-aos-duration="1500" data-aos-delay="500" data-aos="fade-left" class="dates">8-12 июня 2020г.</div>
                <h1 data-aos="zoom-in">
            ...
            <div class="raiting-row">
                <div class="block"  data-aos="zoom-in">
                    <div class="pair">
                        ...
                        <div class="date">Рейтинг 2 из 5</div>
                    </div>
                    <!-- /.pair -->
                    <ul class="stars">
                        <li></li>
            ...
            <div class="reasons-column">
                <div class="reason">
                    <div class="text" data-aos="fade-up" data-aos-duration="1500">
                        ...
                        <p>На протяжении 4-х ночей нашего путешествия группа будет проживать в двухместных номерах отелей, гестхаусов (гостевых домов), которые мы самостоятельно проверили. Каждый гость будет жить в чистоте, комфорте, со всеми необходимыми удобствами, без излишеств. В отелях есть горячая вода, свет, кондиционер, интернет. По утрам доступен завтрак. Если Вы отправляетесь в путешествие один, мы подселим в номер кого-то из группы Вашего пола. </p>
                    </div>
                    <!-- /.text -->
                    <div class="images">
                ...
                <div class="reason inverse"> 
                    <div class="text" data-aos="fade-up" data-aos-duration="1500">
                        ...
                        <p>Нас ждет нестандартное, но очень вкусное питание – все продукты мы будем покупать в сети гипермаркетов Bonus, на местных рынках, а после самостоятельно готовить еду. Отказаться от блюд ресторанов, кафе – очень интересный, полезный опыт. Я уверяю, что наша еда Вам понравится. Питание включено в стоимость. Если Вам понадобится приобрести продукты, которые не входят в наш список, они оплачиваются отдельно. Но я думаю, такой необходимости не возникнет</p>
                    </div>
                    <!-- /.text -->
                ...
                <div class="reason inverse"> 
                    <div class="text" data-aos="fade-up" data-aos-duration="1500">
                        <div class="h3">Постоянный доступ в интернет</div>

                        <p>В любой момент путешествия Вы можете общаться в социальных сетях, делиться впечатлениями с близкими, выкладывать фотографии. В стоимость включено использование Wi-Fi в машине, в гостевых домах, отелях.</p>
                    </div>
                    <!-- /.text -->
        ...
        <div class="container">
            ...
            <div class="features">
                <div class="feature">
                    ...
                    <p>Летим WizzAir из Вильнюса или Варшавы (ориентировочная стоимость 100-200€, в зависимости от сезона). Сейчас на даты 8-12 июня цена 160€ туда обратно. Для лета это очень вкусно!<br> Вы можете прилететь в Рейкьявик из любого города. Москва, Рига, Минск и т.д.</p>
                </div>
                <!-- /.feature -->
                <div class="feature">
                    <div class="image">
                    ...
                    <p>Подходит любая многократная <br> шенгенская виза (60€). <br> Скорее всего она у Вас уже есть</p>
                </div>
                <!-- /.feature -->
                <div class="feature">
                    <div class="image">
                    ...
                    <p>Едвали у Вас будет время на них. Наш маршрут максимально выстроен на удовольствии. Не будет никакой нужды.</p>
                </div>
                <!-- /.feature -->
            </div>
            <!-- /.features -->
